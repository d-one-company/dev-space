    ...
    <div className="flex w-full flex-col items-start gap-5 rounded-lg bg-onyx p-4">
      <div className="flex w-full items-center justify-between text-white">
        <div className="flex items-center gap-2">
          <div className="flex items-center rounded-md bg-gold-drop p-0.5 text-black">
            <ArrowUp size={15} />
          </div>
          <p>Introducing Pro</p>
        </div>
      ...
      <p className="text-davy-gray">Boost your publishing with our new premium features.</p>
